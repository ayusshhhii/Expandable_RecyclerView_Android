...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new DataModel(nestedList1 , "Instants"));
        mList.add(new DataModel( nestedList2,"Stationary Items"));
        mList.add(new DataModel( nestedList3,"Household Items"));
        mList.add(new DataModel(nestedList4 ,"Groceries"));
